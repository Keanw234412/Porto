...
function initParticles() {
    ...
    const particles = [];
    const particleCount = 30; // Dikurangi dari 100 menjadi 30
    ...
    function animate() {
        ...
        // Connect nearby particles - dengan optimasi
        const maxDistance = 120; // Dinaikkan sedikit untuk kompensasi particle yang lebih sedikit
        
        for (let i = 0; i < particles.length; i++) {
            // Batasi checking hanya ke 5 particle terdekat
